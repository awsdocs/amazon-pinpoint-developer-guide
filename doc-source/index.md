...
+ [Using the Amazon Pinpoint SMS and Voice API, version 2](sms-voice-v2.md)
...
+ [Code examples for Amazon Pinpoint using AWS SDKs](service_code_examples.md)
   + [Code examples for Amazon Pinpoint using AWS SDKs](service_code_examples_pinpoint.md)
      + [Actions for Amazon Pinpoint using AWS SDKs](service_code_examples_pinpoint_actions.md)
   ...
   + [Code examples for Amazon Pinpoint SMS and Voice API using AWS SDKs](service_code_examples_pinpoint-sms-voice.md)
      + [Actions for Amazon Pinpoint SMS and Voice API using AWS SDKs](service_code_examples_pinpoint-sms-voice_actions.md)
