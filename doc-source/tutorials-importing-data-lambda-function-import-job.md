# Step 6: Create the Lambda Function Imports Records Into Amazon Pinpoint<a name="tutorials-importing-data-lambda-function-import-job"></a>
...
1. Under **Environment variables**, do the following:
   ...
   + In the third row, create a variable with a key of **importRoleArn**\. Next, set the value to the Amazon Resource Name of the IAM role that you created in [Step 2\.2](tutorials-importing-data-create-iam-roles.md#tutorials-importing-data-create-iam-roles-pinpoint-import)\.
