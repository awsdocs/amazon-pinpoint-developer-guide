# Using Amazon Pinpoint with an AWS SDK<a name="sdk-general-information-section"></a>
...
For examples specific to Amazon Pinpoint, see [Code examples for Amazon Pinpoint](service_code_examples.md)\.
